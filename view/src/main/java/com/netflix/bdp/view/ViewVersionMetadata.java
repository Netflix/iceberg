...
public class ViewVersionMetadata {
    ...
    public static ViewVersionMetadata newViewVersionMetadata(BaseVersion version, String location,
                                                             ViewDefinition definition, Map<String, String> properties) {

        return new ViewVersionMetadata(version, location, definition,
                properties,
                ImmutableList.of(), ImmutableList.of());
    }

    public static ViewVersionMetadata newViewVersionMetadata(BaseVersion version, String location, ViewDefinition definition,
                                                             ViewVersionMetadata viewVersionMetadata, Map<String, String> properties) {
        return new ViewVersionMetadata(version, location, definition,
                properties,
                viewVersionMetadata.versions(), viewVersionMetadata.history());
    }
    ...
    public ViewVersionMetadata(String location, ViewDefinition definition, Map<String, String> properties,
                               int currentVersionId, List<Version> versions, List<HistoryEntry> versionLog) {
    ...
    ViewVersionMetadata(BaseVersion version,
                        String location,
        ...
        int numVersionsToKeep = propertyAsInt(
                ViewProperties.VERSION_HISTORY_SIZE, ViewProperties.VERSION_HISTORY_SIZE_DEFAULT);
        if (allVersions.size() > numVersionsToKeep) {
            this.versions = ImmutableList.<Version>builder()
                    .addAll(allVersions.subList(allVersions.size() - numVersionsToKeep, allVersions.size()))
                    .build();
            this.versionLog = ImmutableList.<HistoryEntry>builder()
    ...
    public ViewVersionMetadata replaceProperties(Map<String, String> newProperties) {
        ...
        return new ViewVersionMetadata(location, definition, newProperties,
                currentVersionId, versions, versionLog);
    }
}
