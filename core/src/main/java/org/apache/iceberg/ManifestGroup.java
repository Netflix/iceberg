...
class ManifestGroup {
  ...
  ManifestGroup ignoreDeleted(boolean shouldIgnoreDeleted) {
    this.ignoreDeleted = shouldIgnoreDeleted;
    return this;
  }
  ...
  ManifestGroup ignoreExisting(boolean shouldIgnoreExisting) {
    this.ignoreExisting = shouldIgnoreExisting;
    return this;
  }
