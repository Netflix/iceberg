...
public class IcebergStorage extends LoadFunc implements LoadMetadata, LoadPredicatePushdown, LoadPushDown {
  ...
  public void setLocation(String location, Job job) {
    ...
    copyUDFContextToScopedConfiguration(conf, ICEBERG_SCHEMA);
    copyUDFContextToScopedConfiguration(conf, ICEBERG_PROJECTED_FIELDS);
    copyUDFContextToScopedConfiguration(conf, ICEBERG_FILTER_EXPRESSION);
  }
